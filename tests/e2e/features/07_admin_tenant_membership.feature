...
Feature: Admin tenant membership and per-tenant roles
  ...
  Scenario: Assign new tenant to bob with read and write roles
    ...
    And I open the admin user editor for "bob@tenant-b.local"
    ...
    Then the tenant members should include "bob@tenant-b.local" with roles "read" and "write"
