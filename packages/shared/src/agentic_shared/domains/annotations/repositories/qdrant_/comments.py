...
class QdrantCommentReadRepository(CommentReadRepository):
    def __init__(self, client: QdrantClient) -> None:
        self._chunks = QdrantReadRepository[ChunkPointPayload](client, ChunkPointPayload)
...
class QdrantCommentWriteRepository(
    QdrantWriteRepository[CommentPointPayload], CommentWriteRepository
):
    def __init__(self, client: QdrantClient) -> None:
