...
from agentic_shared.core.i18n.locale import DEFAULT_LOCALE

_LOCALES_DIR = Path(__file__).resolve().parents[2] / "locales" / "messages"
...
def _load_messages() -> dict[str, dict[str, str]]:
    ...
    if DEFAULT_LOCALE not in by_locale:
        default_path = _LOCALES_DIR / f"{DEFAULT_LOCALE}.json"
