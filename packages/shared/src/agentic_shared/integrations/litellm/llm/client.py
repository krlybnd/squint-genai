...
class LiteLLMChatClient(IntegrationClient[LiteLLMChatSettings]):
    """Chat completions against LiteLLM (OpenAI-compatible HTTP API)."""
    ...
    async def chat_completion(
        ...
        *,
        ...
        self._logger.info("chat completion model=%s messages=%d", resolved, len(messages))
    ...
    async def stream_chat_completion(
        ...
        *,
        ...
        resolved = model or self._model
        self._logger.info("chat completion stream model=%s messages=%d", resolved, len(messages))
